...
in

  {
    ...
    functions = {
      hms = ''NIXPKGS_ALLOW_UNFREE=1 home-manager switch --impure --cores 12 --flake ${my.config.nixpkgs}#$argv'';
      nrs = "sudo nixos-rebuild switch --impure --flake ${my.config.nixpkgs}#$argv";
    };
  };
  }
